...
# --- Sidebar ---
username = st.sidebar.text_input('Username', key="username", value="guest")
prompt = st.sidebar.chat_input("Digite uma mensagem")
...
if prompt:
    ...
    # if len(mensagens) >= 10:
    #     mensagens.insert(0,{"username": username, "mensagem": prompt})
    #     mensagens.pop()
    # else:
    #     mensagens.insert(0,{"username": username, "mensagem": prompt})
